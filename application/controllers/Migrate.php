...
class Migrate extends MX_Controller
{
	...
	protected function _get_file_content($file_name = '')
	{
		...
		$file_content .= '	public function __construct()'  .  PHP_EOL;
		$file_content .= '	{'  .  PHP_EOL;
		$file_content .= '		parent::__construct();'  .  PHP_EOL;
		$file_content .= ''  .  PHP_EOL;
		$file_content .= '		$this->load->helper(\'db\');'  .  PHP_EOL;
		$file_content .= '		$this->attributes = array(\'ENGINE\' => \'InnoDB\');'  .  PHP_EOL;
		$file_content .= '	}'  .  PHP_EOL;
		...
		else
		{
			...
			$file_content .= '				\'constraint\'     => \'11\','  .  PHP_EOL;
			$file_content .= '				\'unsigned\'       => TRUE,'  .  PHP_EOL;
			$file_content .= '				\'auto_increment\' => TRUE'  .  PHP_EOL;
			$file_content .= '			),'  .  PHP_EOL;

			$file_content .= ''  .  PHP_EOL;
			
			$file_content .= '			\'created_at\' => array('  .  PHP_EOL;
			$file_content .= '				\'type\'           => \'DATETIME\','  .  PHP_EOL;
			$file_content .= '				\'null\'           => TRUE'  .  PHP_EOL;
			$file_content .= '				),'  .  PHP_EOL;

			$file_content .= '			\'created_id\' => array('  .  PHP_EOL;
			$file_content .= '				\'type\'           => \'MEDIUMINT\','  .  PHP_EOL;
			$file_content .= '				\'constraint\'     => \'8\','  .  PHP_EOL;
			$file_content .= '				\'unsigned\'       => TRUE,'  .  PHP_EOL;
			$file_content .= '				\'null\'           => TRUE'  .  PHP_EOL;
			$file_content .= '			),'  .  PHP_EOL;

			$file_content .= '			\'updated_at\' => array('  .  PHP_EOL;
			$file_content .= '				\'type\'           => \'DATETIME\','  .  PHP_EOL;
			$file_content .= '				\'null\'           => TRUE'  .  PHP_EOL;
			$file_content .= '			),'  .  PHP_EOL;

			$file_content .= '			\'updated_id\' => array('  .  PHP_EOL;
			$file_content .= '				\'type\'           => \'MEDIUMINT\','  .  PHP_EOL;
			$file_content .= '				\'constraint\'     => \'8\','  .  PHP_EOL;
			$file_content .= '				\'unsigned\'       => TRUE,'  .  PHP_EOL;
			$file_content .= '				\'null\'           => TRUE'  .  PHP_EOL;
			...
			$file_content .= '		$this->dbforge->create_table($'.'this->_table_name, FALSE, $this->attributes);'  .  PHP_EOL;
		}
