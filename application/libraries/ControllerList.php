...
class ControllerList {
    ...
    private function setControllers() {
        ...
        foreach(glob(APPPATH . 'modules/*') as $modules) {
            $dirnameModules = basename($modules, EXT);
        foreach(glob(APPPATH . 'modules/'.$dirnameModules.'/controllers/*') as $controller) {
            ...
            if(is_dir($controller)) {
                ...
                foreach(glob(APPPATH . 'modules/'.$dirnameModules.'/'.'controllers/'.$dirname.'/*') as $subdircontroller) {    
